...
public class LineParserTests {
    ...
    public void createTable() throws Exception {
        Set<String> inputTablesExpected = new HashSet<>();
        Set<String> outputTablesExpected = new HashSet<>();
        Set<String> conditions = new HashSet<>();
        Set<ColLine> lineSetExpected = new HashSet<>();
        ...
        Set<String> fromNameSet1 = new LinkedHashSet<>();
        ...
        Set<String> fromNameSet2 = new LinkedHashSet<>();
    ...
    public void testParseMap() throws Exception {
        ...
        Set<String> fromNameSet3 = new LinkedHashSet<>();
        ...
        Set<String> fromNameSet4 = new LinkedHashSet<>();
    ...
    public void testParseFun2() throws Exception {
        ...
        Set<String> fromNameSet5 = new LinkedHashSet<>();
    ...
    private Set<String> clone(Set<String> set) {
        Set<String> list2 = new HashSet<>(set.size());
        list2.addAll(set);
        return list2;
    }
